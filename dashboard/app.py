...
7a. **איכות תוכן — לא generic. חובה.** הקהילה היא "אלהוריים וזה" — מבוגרים צ'יילדפרי בעברית, בני 30-50, עם ערוצים על gaming, סרטים, אומנות, פוליטיקה, גיקים, בישול וכד'. הימנע מתבניות חלולות כמו "מה היה היום?" או "ספרו דבר טוב". במקום זאת:
   ...
   - **הצעות פעילות מותרות ומועדפות**: בנוסף ל-morning/evening/discussion, אתה יכול להציע custom-type:
     - **משחק לערב היום** — "מי בא לשחק [שם משחק] ב-[שעה] בדיסקורד?" — שים ב-regular_slots עם type="discussion", category הקרוב (gaming) ו-text שמזמין. סמן ב-needs_review=true כי זה הצעה אקטיבית.
     - **רעיון לאירוע השבוע** — "אנחנו בקהילה צ'ילדפרי, מי בעניין של מפגש [סוג] בסוף שבוע הבא?".
     - **פולס מהיר** — "טוב או רע: סדרה X" — תכלול 2-4 אופציות בטקסט.
