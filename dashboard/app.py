...
def _ensure_special_pending_reviews(items):
    wanted_items = [
        ...
        {
            "id": "music-trivia-pool-2026-04-27-q1",
            "title": "🎵 מוזיקה #1 (תוספת לבריכה) — אירוויזיון 1979",
            "channel": "מאגר טריוויה · מוזיקה",
            "when": "לפני 22:00 הערב",
            "preview": "❓ איזה שיר זיכה את ישראל בניצחון באירוויזיון 1979 בביצוע גלי עטרי ולהקת חלב ודבש?\n\n1. אבניבי\n2. הללויה  ✅\n3. דיווה\n4. תודה",
            "note": "אישור = להוסיף ל-config/trivia.yaml עם category=מוזיקה. ממלא את בריכת מוזיקה ל-5 שאלות לסיבוב 22:00.",
        },
        {
            "id": "music-trivia-pool-2026-04-27-q2",
            "title": "🎵 מוזיקה #2 (תוספת לבריכה) — מוצרט / חליל הקסם",
            "channel": "מאגר טריוויה · מוזיקה",
            "when": "לפני 22:00 הערב",
            "preview": "❓ מי הלחין את האופרה 'חליל הקסם' (Die Zauberflöte)?\n\n1. יוהאן סבסטיאן באך\n2. וולפגנג אמדאוס מוצרט  ✅\n3. יוהנס ברהמס\n4. ריכרד וגנר",
            "note": "אישור = להוסיף ל-config/trivia.yaml עם category=מוזיקה. קלאסי, לא חוזר על שאלת בטהובן הקיימת.",
        },
        {
            "id": "music-trivia-pool-2026-04-27-q3",
            "title": "🎵 מוזיקה #3 (תוספת לבריכה) — Pink Floyd",
            "channel": "מאגר טריוויה · מוזיקה",
            "when": "לפני 22:00 הערב",
            "preview": "❓ באיזו שנה יצא האלבום 'The Dark Side of the Moon' של פינק פלויד?\n\n1. 1969\n2. 1973  ✅\n3. 1977\n4. 1981",
            "note": "אישור = להוסיף ל-config/trivia.yaml עם category=מוזיקה. רוק קלאסי, גלובלי.",
        },
        {
            "id": "music-trivia-pool-2026-04-27-q4",
            "title": "🎵 מוזיקה #4 (תוספת לבריכה) — כלי נגינה",
            "channel": "מאגר טריוויה · מוזיקה",
            "when": "לפני 22:00 הערב",
            "preview": "❓ כמה מיתרים יש בכינור סטנדרטי?\n\n1. 3\n2. 4  ✅\n3. 5\n4. 6",
            "note": "אישור = להוסיף ל-config/trivia.yaml עם category=מוזיקה. שאלת תרבות מוזיקלית בסיסית.",
        },
    ]
